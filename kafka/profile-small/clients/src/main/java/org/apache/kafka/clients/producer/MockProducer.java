...
public class MockProducer<K, V> implements Producer<K, V> {
    ...
    public MockProducer(final Cluster cluster, final boolean autoComplete, final Partitioner partitioner, final Serializer<K> keySerializer, final Serializer<V> valueSerializer) {
        ...
        this.sent = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        this.uncommittedSends = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        this.consumerGroupOffsets = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
