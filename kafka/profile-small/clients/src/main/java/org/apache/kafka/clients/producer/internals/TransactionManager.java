...
public class TransactionManager {
    ...
    public TransactionManager(LogContext logContext, String transactionalId, int transactionTimeoutMs, long retryBackoffMs) {
        ...
        this.newPartitionsInTransaction = new org.eclipse.collections.impl.set.mutable.UnifiedSet<>();
        ...
        this.partitionsWithUnresolvedSequences = new org.eclipse.collections.impl.set.mutable.UnifiedSet<>();
