...
public class CsrfPreventionFilter extends CsrfPreventionFilterBase {
    ...
    private final Set<String> entryPoints = new org.eclipse.collections.impl.set.mutable.UnifiedSet<>();
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (request instanceof HttpServletRequest && response instanceof HttpServletResponse) {
            ...
            LruCache<String> nonceCache = (session == null) ? null : (LruCache<String>) session.getAttribute(Constants.CSRF_NONCE_SESSION_ATTR_NAME);
            if (!skipNonceCheck) {
