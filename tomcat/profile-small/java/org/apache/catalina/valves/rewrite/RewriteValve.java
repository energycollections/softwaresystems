...
public class RewriteValve extends ValveBase {
     ...
     */
    protected Map<String, RewriteMap> maps = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        if (getContainer() instanceof Context) {
            ...
            try {
                ...
                if ((is == null) && (containerLog.isDebugEnabled())) {
                    containerLog.debug("No configuration resource found: " + resourceName + " in " + getConfigBase() + " or in the classloader");
                }
            } catch (Exception e) {
    ...
    protected void parse(BufferedReader reader) throws LifecycleException {
        List<RewriteRule> rules = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
