...
public class CrawlerSessionManagerValve extends ValveBase implements HttpSessionBindingListener {
    ...
    private final Map<String, String> clientIpSessionId = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();

    private final Map<String, String> sessionIdClientIp = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();
    ...
    public void invoke(Request request, Response response) throws IOException, ServletException {
        ...
        if (log.isDebugEnabled()) {
            log.debug(request.hashCode() + ": ClientIp=" + clientIp + ", RequestedSessionId=" + request.getRequestedSessionId());
        }
