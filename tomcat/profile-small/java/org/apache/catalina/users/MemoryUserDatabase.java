...
public class MemoryUserDatabase implements UserDatabase {
     ...
     * group name.
     */
    protected final java.util.Map<String, Group> groups = new org.apache.commons.collections4.map.HashedMap<>();
     ...
     * role name.
     */
    protected final java.util.Map<String, Role> roles = new org.apache.commons.collections4.map.HashedMap<>();
     ...
     * user name.
     */
    protected final java.util.Map<String, User> users = new org.apache.commons.collections4.map.HashedMap<>();
