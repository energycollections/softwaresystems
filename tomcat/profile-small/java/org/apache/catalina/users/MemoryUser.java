...
public class MemoryUser extends AbstractUser {
     ...
     */
    protected final java.util.List<Group> groups = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();

    /**
     * The set of {@link Role}s associated with this user.
     */
    protected final java.util.List<Role> roles = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
