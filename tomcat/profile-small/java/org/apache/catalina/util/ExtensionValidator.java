...
public final class ExtensionValidator {
    ...
    private static final List<ManifestResource> containerManifestResources = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
            ...
            if (list != null) {
                for (Extension ext : list) {
                    if (availableList == null) {
                        availableList = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
