...
public class StandardPipeline extends LifecycleBase implements Pipeline {
    ...
    public Valve[] getValves() {
        List<Valve> valveList = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        Valve current = first;
        if (current == null) {
            current = basic;
        }
    ...
    public ObjectName[] getValveObjectNames() {
        List<ObjectName> valveList = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        Valve current = first;
        if (current == null) {
            current = basic;
        }
