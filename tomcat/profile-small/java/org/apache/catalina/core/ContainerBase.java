...
public abstract class ContainerBase extends LifecycleMBeanBase implements Container {
     ...
     */
    protected final java.util.Map<String, Container> children = new org.apache.commons.collections4.map.HashedMap<>();
     ...
     * a deadlock.
     */
    protected final List<ContainerListener> listeners = java.util.Collections.synchronizedList(new java.util.ArrayList<>());
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        List<Future<Void>> results = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public ObjectName[] getChildren() {
        List<ObjectName> names = new org.apache.commons.collections4.list.NodeCachingLinkedList<>(children.size());
