...
public class Tomcat {
    ...
    private final Map<String, Logger> pinnedLoggers = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    private final Map<String, String> userPass = new org.apache.commons.collections4.map.HashedMap<>();

    private final Map<String, List<String>> userRoles = new org.apache.commons.collections4.map.HashedMap<>();
