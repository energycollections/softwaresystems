...
public abstract class AbstractAccessLogValve extends ValveBase implements AccessLog {
    ...
    protected static class DateFormatCache {
        ...
        private final Map<String, Cache> formatCache = new org.apache.commons.collections4.map.HashedMap<>();
        ...
        public void addElement(CharArrayWriter buf, Date date, Request request, Response response, long time) {
            if (response != null) {
                ...
                if (100 <= status && status < 1000) {
                    buf.append((char) ('0' + (status / 100))).append((char) ('0' + ((status / 10) % 10))).append((char) ('0' + (status % 10)));
                } else {
    ...
    protected AccessLogElement[] createLogElements() {
        List<AccessLogElement> list = new org.eclipse.collections.impl.list.mutable.FastList<>();
