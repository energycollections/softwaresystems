...
public class JNDIRealm extends RealmBase {
    ...
    protected User getUser(DirContext context, String username, String credentials, int curUserPattern) throws NamingException {
        ...
        List<String> list = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    protected List<String> getRoles(DirContext context, User user) throws NamingException {
        ...
        if (getRoleNested()) {
            ...
            while (!newGroups.isEmpty()) {
                ...
                Map<String, String> newThisRound = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    private DirContext createTlsDirContext(Hashtable<String, String> env) throws NamingException {
        Map<String, Object> savedEnv = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    protected String[] parseUserPatternString(String userPatternString) {
        if (userPatternString != null) {
            List<String> pathList = new org.eclipse.collections.impl.list.mutable.FastList<>();
