...
public final class SecurityUtil {
     ...
     */
    private static final Map<Class<?>, Method[]> classCache = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();
     ...
     * @throws Exception an execution error occurred
     */
    public static void doAsPrivilege(final String methodName, final Filter targetObject, final Class<?>[] targetParameterTypes, final Object[] targetParameterValues, Principal principal) throws Exception {
        Method method = null;
