...
public class MemoryUser extends AbstractUser {
     ...
     */
    protected final java.util.List<Group> groups = new org.eclipse.collections.impl.list.mutable.FastList<>();

    /**
     * The set of {@link Role}s associated with this user.
     */
    protected final java.util.List<Role> roles = new org.eclipse.collections.impl.list.mutable.FastList<>();
