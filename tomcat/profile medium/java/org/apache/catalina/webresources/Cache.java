...
public class Cache {
    ...
    protected void backgroundProcess() {
        ...
        java.util.Set<CachedResource> orderedResources = new org.eclipse.collections.impl.set.sorted.mutable.TreeSortedSet<>(new EvictionOrder());
        ...
        if (newSize > targetSize) {
            log.info(sm.getString("cache.backgroundEvictFail", Long.valueOf(TARGET_FREE_PERCENT_BACKGROUND), root.getContext().getName(), Long.valueOf(newSize / 1024)));
        }
    }
