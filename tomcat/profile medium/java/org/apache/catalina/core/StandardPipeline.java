...
public class StandardPipeline extends LifecycleBase implements Pipeline {
    ...
    public Valve[] getValves() {
        List<Valve> valveList = new org.eclipse.collections.impl.list.mutable.FastList<>();
        Valve current = first;
        if (current == null) {
            current = basic;
        }
    ...
    public ObjectName[] getValveObjectNames() {
        List<ObjectName> valveList = new org.eclipse.collections.impl.list.mutable.FastList<>();
        Valve current = first;
        if (current == null) {
            current = basic;
        }
