...
public final class ExtensionValidator {
    ...
    private static final List<ManifestResource> containerManifestResources = new org.eclipse.collections.impl.list.mutable.FastList<>();
            ...
            if (list != null) {
                for (Extension ext : list) {
                    if (availableList == null) {
                        availableList = new org.eclipse.collections.impl.list.mutable.FastList<>();
