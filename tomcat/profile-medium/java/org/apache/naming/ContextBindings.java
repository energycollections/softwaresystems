...
public class ContextBindings {
     ...
     */
    private static final java.util.Map<Object, Context> objectBindings = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();

    /**
     * Bindings thread - naming context. Keyed by thread.
     */
    private static final java.util.Map<Thread, Context> threadBindings = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();

    /**
     * Bindings thread - object. Keyed by thread.
     */
    private static final java.util.Map<Thread, Object> threadObjectBindings = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();

    /**
     * Bindings class loader - naming context. Keyed by class loader.
     */
    private static final java.util.Map<ClassLoader, Context> clBindings = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();

    /**
     * Bindings class loader - object. Keyed by class loader.
     */
    private static final java.util.Map<ClassLoader, Object> clObjectBindings = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();
