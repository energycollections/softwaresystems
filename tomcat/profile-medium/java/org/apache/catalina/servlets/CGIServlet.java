...
public final class CGIServlet extends HttpServlet {
    ...
    protected class CGIEnvironment {
         ...
         */
        private final java.util.List<String> cmdLineParameters = new org.eclipse.collections.impl.list.mutable.FastList<>();
        ...
        protected boolean setCGIEnvironment(HttpServletRequest req) throws IOException {
             ...
             */
            java.util.Map<String, String> envp = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    protected class CGIRunner {
        ...
        protected String[] hashToStringArray(Hashtable<String, ?> h) throws NullPointerException {
            java.util.List<String> v = java.util.Collections.synchronizedList(new org.eclipse.collections.impl.list.mutable.FastList<>());
        ...
        protected void run() throws IOException {
            ...
            if ((command.contains(File.separator + "." + File.separator)) || (command.contains(File.separator + "..")) || (command.contains(".." + File.separator))) {
            ...
            Process proc = null;
            int bufRead = -1;
            List<String> cmdAndArgs = new org.eclipse.collections.impl.list.mutable.FastList<>();
