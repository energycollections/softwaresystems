...
public class Request implements HttpServletRequest {
    ...
    private static final SimpleDateFormat[] formatsTemplate = { new SimpleDateFormat(FastHttpDateFormat.RFC1123_DATE, Locale.US), new SimpleDateFormat("EEEEEE, dd-MMM-yy HH:mm:ss zzz", Locale.US), new SimpleDateFormat("EEE MMMM d HH:mm:ss yyyy", Locale.US) };
     ...
     */
    protected final java.util.List<Locale> locales = new org.eclipse.collections.impl.list.mutable.FastList<>();

    /**
     * Internal notes associated with this request by Catalina components
     * and event listeners.
     */
    private final transient java.util.Map<String, Object> notes = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    private void parseParts(boolean explicit) {
        ...
        try {
            ...
            parts = new org.eclipse.collections.impl.list.mutable.FastList<>();
            try {
