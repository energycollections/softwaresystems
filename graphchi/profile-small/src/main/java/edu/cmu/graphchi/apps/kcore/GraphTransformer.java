...
public class GraphTransformer implements GraphChiProgram<Integer, Integer> {
    ...
    public void update(ChiVertex<Integer, Integer> vertex, GraphChiContext context) {
        java.util.List<Integer> outNeighbors = new org.apache.commons.collections4.list.NodeCachingLinkedList<Integer>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (inputFilePath.equals("pipein")) {
            // Allow piping graph in
