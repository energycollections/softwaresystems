...
public class VertexQuery {
    ...
    public VertexQuery(String baseFilename, int numShards) throws IOException {
        shards = new org.eclipse.collections.impl.list.mutable.FastList<Shard>();
    ...
    public HashMap<Integer, ArrayList<Integer>> queryOutNeighbors(final Collection<Integer> queryVertices) {
        ...
        List<Future<HashMap<Integer, ArrayList<Integer>>>> queryFutures = new org.eclipse.collections.impl.list.mutable.FastList<Future<HashMap<Integer, ArrayList<Integer>>>>();
        /* Check which ones are in cache */
        long st = System.currentTimeMillis();
    ...
    public HashSet<Integer> queryOutNeighbors(final int internalId) throws IOException {
        ...
        List<Future<HashSet<Integer>>> queryFutures = new org.eclipse.collections.impl.list.mutable.FastList<Future<HashSet<Integer>>>();
    ...
    static class Shard {
        ...
        public <VT> List<VertexIdValue<VT>> queryWithValues(int vertexId, BytesToValueConverter<VT> conv) throws IOException {
                ...
                if (curvid == vertexId) {
                    while (--n >= 0) {
                        ...
                        if (blockId != curBlockId) {
                            String blockFileName = ChiFilenames.getFilenameShardEdataBlock(edataShardName, blockId, blockSize);
                            curBlockId = blockId;
