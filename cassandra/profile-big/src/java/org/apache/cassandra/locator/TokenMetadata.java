...
public class TokenMetadata {
    ...
    private final Set<InetAddress> leavingEndpoints = new java.util.LinkedHashSet<>();
    ...
    private final Set<Pair<Token, InetAddress>> movingEndpoints = new java.util.LinkedHashSet<>();
