...
public class MapSerializer<K, V> extends CollectionSerializer<Map<K, V>> {
    ...
    // interning instances
    private static final Map<Pair<TypeSerializer<?>, TypeSerializer<?>>, MapSerializer> instances = new org.apache.commons.collections4.map.HashedMap<Pair<TypeSerializer<?>, TypeSerializer<?>>, MapSerializer>();
