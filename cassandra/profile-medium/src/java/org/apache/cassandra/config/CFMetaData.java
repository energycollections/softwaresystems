...
public final class CFMetaData {
    ...
    public static class Builder {
        ...
        private final List<Pair<ColumnIdentifier, AbstractType>> partitionKeys = new org.eclipse.collections.impl.list.mutable.FastList<>();

        private final List<Pair<ColumnIdentifier, AbstractType>> clusteringColumns = new org.eclipse.collections.impl.list.mutable.FastList<>();

        private final List<Pair<ColumnIdentifier, AbstractType>> staticColumns = new org.eclipse.collections.impl.list.mutable.FastList<>();

        private final List<Pair<ColumnIdentifier, AbstractType>> regularColumns = new org.eclipse.collections.impl.list.mutable.FastList<>();
