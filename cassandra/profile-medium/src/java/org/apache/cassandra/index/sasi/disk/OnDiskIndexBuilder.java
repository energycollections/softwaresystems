...
public class OnDiskIndexBuilder {
    ...
    private static final SequentialWriterOption WRITER_OPTION = SequentialWriterOption.newBuilder().bufferSize(BLOCK_SIZE).build();
    ...
    public OnDiskIndexBuilder(AbstractType<?> keyComparator, AbstractType<?> comparator, Mode mode, boolean marksPartials) {
        ...
        this.terms = new org.apache.commons.collections4.map.HashedMap<>();
