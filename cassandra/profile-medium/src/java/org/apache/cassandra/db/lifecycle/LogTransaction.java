...
class LogTransaction extends Transactional.AbstractTransactional implements Transactional {
    ...
    private static class TransactionTidier implements RefCounted.Tidy, Runnable {
        ...
        public void run() {
            ...
            if (err != null) {
                logger.info("Failed deleting files for transaction log {}, we'll retry after GC and on on server restart", data, err);
    ...
    private static final class LogFilesByName {
        ...
        // physical files.
        Map<String, List<File>> files = new org.apache.commons.collections4.map.HashedMap<>();
