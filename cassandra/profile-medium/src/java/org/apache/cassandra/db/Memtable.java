...
public class Memtable implements Comparable<Memtable> {
    ...
    private static class ColumnsCollector {
        ...
        private final java.util.Map<ColumnDefinition, AtomicBoolean> predefined = new org.apache.commons.collections4.map.HashedMap<>();
        ...
        public PartitionColumns get() {
            ...
            for (Map.Entry<ColumnDefinition, AtomicBoolean> e : predefined.entrySet()) if (e.getValue().get())
