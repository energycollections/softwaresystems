...
public abstract class AbstractCompositeType extends AbstractType<ByteBuffer> {
    ...
    public ByteBuffer[] split(ByteBuffer name) {
        List<ByteBuffer> l = new org.eclipse.collections.impl.list.mutable.FastList<ByteBuffer>();
    ...
    public ByteBuffer fromString(String source) {
        ...
        List<ByteBuffer> components = new org.eclipse.collections.impl.list.mutable.FastList<ByteBuffer>(parts.size());
        List<ParsedComparator> comparators = new org.eclipse.collections.impl.list.mutable.FastList<ParsedComparator>(parts.size());
