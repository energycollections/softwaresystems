...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean {
    ...
    */
    ...
    private final class Flush implements Runnable {
        ...
        final List<Memtable> memtables = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public Collection<SSTableReader> getOverlappingLiveSSTables(Iterable<SSTableReader> sstables) {
        ...
        List<AbstractBounds<PartitionPosition>> bounds = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public RefViewFragment selectAndReference(Function<View, Iterable<SSTableReader>> filter) {
        ...
        while (true) {
            ...
            if (failingSince <= 0) {
                ...
                List<SSTableReader> released = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public Refs<SSTableReader> getSnapshotSSTableReader(String tag) throws IOException {
        Map<Integer, SSTableReader> active = new org.apache.commons.collections4.map.HashedMap<>();
