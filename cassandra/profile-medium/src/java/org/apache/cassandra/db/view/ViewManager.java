...
public class ViewManager {
    ...
    public void reload() {
        Map<String, ViewDefinition> newViewsByName = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    public void addView(ViewDefinition definition) {
        ...
        if (!keyspace.hasColumnFamilyStore(definition.baseTableId)) {
            logger.warn("Not adding view {} because the base table {} is unknown", definition.viewName, definition.baseTableId);
            return;
        }
