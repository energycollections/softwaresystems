...
public class TableViews extends AbstractCollection<View> {
    ...
    private final List<View> views = java.util.Collections.synchronizedList(new org.eclipse.collections.impl.list.mutable.FastList());
    ...
    private Collection<Mutation> buildMutations(CFMetaData baseTableMetadata, List<ViewUpdateGenerator> generators) {
        ...
        Map<DecoratedKey, Mutation> mutations = new org.apache.commons.collections4.map.HashedMap<>();
