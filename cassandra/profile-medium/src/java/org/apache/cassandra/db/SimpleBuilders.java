...
public abstract class SimpleBuilders {
    ...
    public static class MutationBuilder extends AbstractBuilder<Mutation.SimpleBuilder> implements Mutation.SimpleBuilder {
        ...
        private final Map<UUID, PartitionUpdateBuilder> updateBuilders = new org.apache.commons.collections4.map.HashedMap<>();
        ...
        public Mutation build() {
            ...
            for (PartitionUpdateBuilder builder : updateBuilders.values()) mutation.add(builder.build());
            return mutation;
        }
    }
    ...
    public static class PartitionUpdateBuilder extends AbstractBuilder<PartitionUpdate.SimpleBuilder> implements PartitionUpdate.SimpleBuilder {
        ...
        private final Map<Clustering, RowBuilder> rowBuilders = new org.apache.commons.collections4.map.HashedMap<>();
        ...
        public RangeTombstoneBuilder addRangeTombstone() {
            if (rangeBuilders == null)
                rangeBuilders = new org.eclipse.collections.impl.list.mutable.FastList<>();
