...
public class View {
    ...
    public void updateDefinition(ViewDefinition definition) {
        ...
        List<ColumnDefinition> nonPKDefPartOfViewPK = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public static String relationsToWhereClause(List<Relation> whereClause) {
        List<String> expressions = new org.eclipse.collections.impl.list.mutable.FastList<>(whereClause.size());
