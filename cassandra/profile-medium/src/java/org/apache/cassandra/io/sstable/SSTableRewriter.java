...
public class SSTableRewriter extends Transactional.AbstractTransactional implements Transactional {
    ...
    private final List<SSTableWriter> writers = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    private Map<DecoratedKey, RowIndexEntry> cachedKeys = new org.apache.commons.collections4.map.HashedMap<>();
    ...
    private void moveStarts(SSTableReader newReader, DecoratedKey lowerbound) {
        ...
        if (!cachedKeys.isEmpty()) {
            invalidateKeys = new org.eclipse.collections.impl.list.mutable.FastList<>(cachedKeys.size());
