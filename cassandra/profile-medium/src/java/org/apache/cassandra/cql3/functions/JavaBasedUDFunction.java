...
public final class JavaBasedUDFunction extends UDFunction {
    ...
    private static final UDFExecutorService executor = new UDFExecutorService(new NamedThreadFactory("UserDefinedFunctions", Thread.MIN_PRIORITY, udfClassLoader, new SecurityThreadGroup("UserDefinedFunctions", null, UDFunction::initializeThread)), "userfunction");
    ...
    static final class EcjTargetClassLoader extends SecureClassLoader {
        ...
        // 
        private final Map<String, byte[]> classes = new org.eclipse.collections.impl.map.mutable.ConcurrentHashMap<>();
