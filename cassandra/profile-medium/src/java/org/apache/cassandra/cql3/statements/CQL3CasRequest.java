...
public class CQL3CasRequest implements CASRequest {
    ...
    private final List<RowUpdate> updates = new org.eclipse.collections.impl.list.mutable.FastList<>();

    private final List<RangeDeletion> rangeDeletions = new org.eclipse.collections.impl.list.mutable.FastList<>();
