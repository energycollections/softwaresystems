...
public class SSTableRewriter extends Transactional.AbstractTransactional implements Transactional {
    ...
    private final List<SSTableWriter> writers = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    private void moveStarts(SSTableReader newReader, DecoratedKey lowerbound) {
        ...
        if (!cachedKeys.isEmpty()) {
            invalidateKeys = new org.apache.commons.collections4.list.NodeCachingLinkedList<>(cachedKeys.size());
