...
public class View {
    ...
    public void updateDefinition(ViewDefinition definition) {
        ...
        List<ColumnDefinition> nonPKDefPartOfViewPK = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public static String relationsToWhereClause(List<Relation> whereClause) {
        List<String> expressions = new org.apache.commons.collections4.list.NodeCachingLinkedList<>(whereClause.size());
