...
public class Mutation implements IMutation {
    ...
    protected Mutation(String keyspaceName, DecoratedKey key, Map<UUID, PartitionUpdate> modifications) {
        ...
        for (PartitionUpdate pu : modifications.values()) cdcEnabled |= pu.metadata().params.cdc;
    }
    ...
    public static Mutation merge(List<Mutation> mutations) {
        ...
        Set<UUID> updatedTables = new org.eclipse.collections.impl.set.mutable.UnifiedSet<>();
        String ks = null;
