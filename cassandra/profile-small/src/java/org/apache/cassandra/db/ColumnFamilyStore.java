...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean {
    ...
    */
    ...
    public static void scrubDataDirectories(CFMetaData metadata) throws StartupException {
        Directories directories = new Directories(metadata, initialDirectories);
        Set<File> cleanedDirectories = new org.eclipse.collections.impl.set.mutable.UnifiedSet<>();
    ...
    public synchronized void loadNewSSTables() {
        ...
        Set<Descriptor> currentDescriptors = new org.eclipse.collections.impl.set.mutable.UnifiedSet<>();
    ...
    private final class Flush implements Runnable {
        ...
        final List<Memtable> memtables = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public Collection<SSTableReader> getOverlappingLiveSSTables(Iterable<SSTableReader> sstables) {
        ...
        List<AbstractBounds<PartitionPosition>> bounds = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public RefViewFragment selectAndReference(Function<View, Iterable<SSTableReader>> filter) {
        ...
        while (true) {
            ...
            if (failingSince <= 0) {
                ...
                List<SSTableReader> released = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public CompositeData finishLocalSampling(String sampler, int count) throws OpenDataException {
        ...
        for (Counter<ByteBuffer> counter : samplerResults.topK) {
            ...
            result.put(new CompositeDataSupport(COUNTER_COMPOSITE_TYPE, COUNTER_NAMES, new Object[] { // raw
            ByteBufferUtil.bytesToHex(key), // count
            counter.getCount(), // error
            counter.getError(), // string
            metadata.getKeyValidator().getString(key) }));
        }
