...
public abstract class AbstractCompositeType extends AbstractType<ByteBuffer> {
    ...
    public ByteBuffer[] split(ByteBuffer name) {
        List<ByteBuffer> l = new org.apache.commons.collections4.list.NodeCachingLinkedList<ByteBuffer>();
    ...
    public ByteBuffer fromString(String source) {
        ...
        List<ByteBuffer> components = new org.apache.commons.collections4.list.NodeCachingLinkedList<ByteBuffer>(parts.size());
