...
public class LeveledManifest {
    ...
    public synchronized void replace(Collection<SSTableReader> removed, Collection<SSTableReader> added) {
        ...
        for (SSTableReader ssTableReader : added) add(ssTableReader);
    ...
    public synchronized void repairOverlappingSSTables(int level) {
        ...
        List<SSTableReader> outOfOrderSSTables = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public synchronized int[] getAllLevelSize() {
        ...
        for (int i = 0; i < counts.length; i++) counts[i] = getLevel(i).size();
        return counts;
    }
