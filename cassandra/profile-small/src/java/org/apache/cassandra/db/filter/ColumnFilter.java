...
public class ColumnFilter {
    ...
    // can be null if isFetchAll and _fetched_ == _queried_
    ...
    public static class Builder {
        ...
        private Builder addSubSelection(ColumnSubselection subSelection) {
            ...
            if (subSelections == null)
                subSelections = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public static class Serializer {
        ...
        private static int makeHeaderByte(ColumnFilter selection) {
            return (selection.isFetchAll ? IS_FETCH_ALL_MASK : 0) | (selection.queried != null ? HAS_QUERIED_MASK : 0) | (selection.subSelections != null ? HAS_SUB_SELECTIONS_MASK : 0);
        }
