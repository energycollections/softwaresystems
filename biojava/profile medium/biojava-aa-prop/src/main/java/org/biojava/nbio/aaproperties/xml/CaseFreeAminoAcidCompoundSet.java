...
public class CaseFreeAminoAcidCompoundSet implements CompoundSet<AminoAcidCompound> {
    ...
    private final Map<AminoAcidCompound, Set<AminoAcidCompound>> equivalentsCache = new org.apache.commons.collections4.map.HashedMap<AminoAcidCompound, Set<AminoAcidCompound>>();
