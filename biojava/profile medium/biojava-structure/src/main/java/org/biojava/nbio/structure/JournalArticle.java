...
public class JournalArticle implements Serializable {
    ...
    private List<Author> authorList = new org.eclipse.collections.impl.list.mutable.FastList<Author>();

    private List<Author> editorList = new org.eclipse.collections.impl.list.mutable.FastList<Author>();
