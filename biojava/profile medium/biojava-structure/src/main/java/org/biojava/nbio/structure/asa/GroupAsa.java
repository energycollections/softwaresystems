...
public class GroupAsa implements Serializable {
    ...
    public GroupAsa(Group g) {
        ...
        atomAsaCs = new org.eclipse.collections.impl.list.mutable.FastList<Double>(groupNoHSize);
    }
    ...
    public Object clone() {
        ...
        n.atomAsaUs = new org.eclipse.collections.impl.list.mutable.FastList<Double>(this.atomAsaUs.size());
        n.atomAsaCs = new org.eclipse.collections.impl.list.mutable.FastList<Double>(this.atomAsaCs.size());
