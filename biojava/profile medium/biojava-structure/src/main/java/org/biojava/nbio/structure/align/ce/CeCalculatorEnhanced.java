...
public class CeCalculatorEnhanced {
    ...
    public CeCalculatorEnhanced(CeParameters params) {
        ...
        this.params = params;
        matrixListeners = new org.eclipse.collections.impl.list.mutable.FastList<MatrixListener>();
    }
...
nBestTrace=nTrace;
    ...
    private Atom[] getAtoms(Atom[] ca, int length, boolean clone) throws StructureException {
        List<Atom> atoms = new org.eclipse.collections.impl.list.mutable.FastList<Atom>();
