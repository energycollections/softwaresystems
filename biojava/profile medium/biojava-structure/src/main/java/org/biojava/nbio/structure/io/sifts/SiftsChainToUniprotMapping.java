...
public class SiftsChainToUniprotMapping {
    ...
    private Map<String, SiftsChainEntry> byChainId = new org.apache.commons.collections4.map.HashedMap<String, SiftsChainEntry>();

    private Map<String, SiftsChainEntry> byUniProtId = new org.apache.commons.collections4.map.HashedMap<String, SiftsChainEntry>();
