...
public class MultipleMcOptimizer implements Callable<MultipleAlignment> {
    ...
    public MultipleMcOptimizer(MultipleAlignment seedAln, MultipleMcParameters params, int reference) {
        ...
        List<Block> toDelete = new org.eclipse.collections.impl.list.mutable.FastList<Block>();
        List<BlockSet> emptyBs = new org.eclipse.collections.impl.list.mutable.FastList<BlockSet>();
    ...
    public MultipleAlignment optimize() throws StructureException {
        ...
        while (i < maxIter && conv < convergenceSteps) {
            ...
            List<SortedSet<Integer>> lastFreePool = new org.eclipse.collections.impl.list.mutable.FastList<SortedSet<Integer>>();
