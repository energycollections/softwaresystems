...
public class BasePairParameters implements Serializable {
    ...
    protected List<String> pairingNames = new org.eclipse.collections.impl.list.mutable.FastList<>();

    protected List<Matrix4d> referenceFrames = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public String toString() {
        ...
        for (int i = 0; i < pairingParameters.length; i++) {
            ...
            for (int j = 0; j < 6; j++) result.append(String.format("%5.4f", pairingParameters[i][j]) + " ");
            for (int j = 0; j < 6; j++) result.append(String.format("%5.4f", stepParameters[i][j]) + " ");
            result.append("\n");
        }
