...
public class HelixSolver {
    ...
    private void solve() {
        ...
        for (Entry<Integer[], Integer> entry : interactionMap.entrySet()) {
            ...
            List<Point3d> point1 = new org.eclipse.collections.impl.list.mutable.FastList<Point3d>();
            List<Point3d> point2 = new org.eclipse.collections.impl.list.mutable.FastList<Point3d>();
