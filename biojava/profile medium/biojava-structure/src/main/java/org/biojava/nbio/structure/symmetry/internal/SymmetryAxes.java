...
public class SymmetryAxes {
    ...
    public List<List<Integer>> getRepeatRelation(int level, int firstRepeat) {
        ...
        List<Integer> repeats = new org.eclipse.collections.impl.list.mutable.FastList<>(n);
        List<Integer> equiv = new org.eclipse.collections.impl.list.mutable.FastList<>(n);
        for (int i = 0; i < n; i++) {
