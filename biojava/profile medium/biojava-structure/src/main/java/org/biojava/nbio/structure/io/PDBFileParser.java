...
public class PDBFileParser {
    ...
    // the actual id of the entry
    private String pdbId;

    private Structure structure;

    // a temp data structure to keep all models
    private List<List<Chain>> allModels;

    // contains the ATOM records for each model
    ...
    // contains all the chains for the SEQRES records
    ...
    private java.util.Map<Integer, List<String>> compoundMolIds2chainIds = new org.apache.commons.collections4.map.HashedMap<Integer, List<String>>();

    private List<String> compndLines = new org.eclipse.collections.impl.list.mutable.FastList<String>();

    private List<String> sourceLines = new org.eclipse.collections.impl.list.mutable.FastList<String>();

    private List<String> journalLines = new org.eclipse.collections.impl.list.mutable.FastList<String>();
    ...
    private List<SSBondImpl> ssbonds = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public PDBFileParser() {
        ...
        allModels = new org.eclipse.collections.impl.list.mutable.FastList<>();
        structure = null;
        currentModel = null;
        currentChain = null;
        currentGroup = null;
        ...
        connects = new org.eclipse.collections.impl.list.mutable.FastList<Map<String, Integer>>();
        helixList = new org.eclipse.collections.impl.list.mutable.FastList<Map<String, String>>();
        strandList = new org.eclipse.collections.impl.list.mutable.FastList<Map<String, String>>();
        turnList = new org.eclipse.collections.impl.list.mutable.FastList<Map<String, String>>();
        current_compound = null;
        dbrefs = new org.eclipse.collections.impl.list.mutable.FastList<DBRef>();
        siteMap = null;
        ...
        linkRecords = new org.eclipse.collections.impl.list.mutable.FastList<LinkRecord>();
    ...
    private void pdb_SOURCE_Handler(String line) {
        ...
        if (!fieldList[0].equals("") && sourceFieldValues.contains(fieldList[0])) {
            ...
            if (mR.matches()) {
                try {
                    ...
                    if (pdbHeader.getResolution() != PDBHeader.DEFAULT_RESOLUTION) {
                        logger.warn("More than 1 resolution value present, will use last one {} and discard previous {} ", mR.group(1), String.format("%4.2f", pdbHeader.getResolution()));
                    }
    ...
    private void pdb_MTRIXn_Handler(String line) {
        ...
        try {
            ...
            if (ncsOperators == null) {
                ...
                ncsOperators = new org.eclipse.collections.impl.list.mutable.FastList<Matrix4d>();
            }
    ...
    private void pdb_ATOM_Handler(String line) {
        ...
        if (startOfModel) {
            ...
            currentModel = new org.eclipse.collections.impl.list.mutable.FastList<>();
        }
    ...
    private void pdb_SSBOND_Handler(String line) {
        ...
        if (line.length() >= 72) {
            ...
            !symop1.equals("") && !symop2.equals("") && (!symop1.equals("1555") || !symop2.equals("1555"))) {
    ...
    private void assignChainsAndEntities() {
        ...
        List<List<Chain>> nonPolyModels = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    private List<Author> authorBuilder(String authorString) {
        ...
        if (authors.length == 1) {
            ...
            for (int i = 0; i < authors.length; i++) {
                ...
                } else // again there might be a consortium name so there may be no elements
