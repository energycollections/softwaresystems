...
public class MomentsOfInertia {
    ...
    private List<Point3d> points = new org.eclipse.collections.impl.list.mutable.FastList<Point3d>();

    private List<Double> masses = new org.eclipse.collections.impl.list.mutable.FastList<Double>();
    ...
    private void diagonalizeTensor() {
        ...
        for (int i = 0; i < 3; i++) orientation.setColumn(i, principalAxes[i]);
        orientation.negate();
    }
}
