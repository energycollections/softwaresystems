...
public class MultipleAlignmentEnsembleImpl extends AbstractScoresCache implements MultipleAlignmentEnsemble, Serializable, Cloneable {
    ...
    public MultipleAlignmentEnsembleImpl(MultipleAlignmentEnsembleImpl e) {
        ...
        if (e.distanceMatrix != null) {
            ...
            distanceMatrix = new org.eclipse.collections.impl.list.mutable.FastList<Matrix>();
        ...
        if (e.atomArrays != null) {
            atomArrays = new org.eclipse.collections.impl.list.mutable.FastList<Atom[]>(e.atomArrays);
        }
    ...
    public MultipleAlignmentEnsembleImpl(AFPChain afp, Atom[] ca1, Atom[] ca2, boolean flexible) {
        ...
        } else // Create a Block for every block in AFPChain if not flexible
        {
            BlockSet blockSet = new BlockSetImpl(msa);
            Matrix4d blockTr = null;
            try {
    ...
    public void updateAtomArrays() throws IOException, StructureException {
        ...
        atomArrays = new org.eclipse.collections.impl.list.mutable.FastList<Atom[]>();
    ...
    public void clear() {
        super.clear();
        distanceMatrix = null;
        for (MultipleAlignment a : getMultipleAlignments()) a.clear();
    }
}
