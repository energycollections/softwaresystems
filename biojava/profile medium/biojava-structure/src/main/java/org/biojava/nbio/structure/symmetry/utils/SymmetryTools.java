    ...
    public static void updateSymmetryTransformation(SymmetryAxes axes, MultipleAlignment msa) throws StructureException {
        ...
        if (axes != null) {
            for (int level = 0; level < axes.getNumLevels(); level++) {
                ...
                List<Atom> list1 = new org.eclipse.collections.impl.list.mutable.FastList<Atom>();
                List<Atom> list2 = new org.eclipse.collections.impl.list.mutable.FastList<Atom>();
