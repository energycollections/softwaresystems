...
public abstract class AbstractSequence<C extends Compound> implements Sequence<C> {
    ...
    private java.util.List<String> notesList = new org.eclipse.collections.impl.list.mutable.FastList<String>();
    ...
    private java.util.List<FeatureInterface<AbstractSequence<C>, C>> features = new org.eclipse.collections.impl.list.mutable.FastList<FeatureInterface<AbstractSequence<C>, C>>();
