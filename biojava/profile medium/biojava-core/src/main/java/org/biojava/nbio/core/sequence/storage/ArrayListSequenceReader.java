...
public class ArrayListSequenceReader<C extends Compound> implements SequenceReader<C> {
    ...
    private java.util.List<C> parsedCompounds = new org.eclipse.collections.impl.list.mutable.FastList<C>();
    ...
    public void setContents(String sequence) throws CompoundNotFoundException {
        ...
        // get the array size correct
        parsedCompounds.ensureCapacity(length);
        for (int i = 0; i < length; ) {
            String compoundStr = null;
            C compound = null;
            if (maxCompundLengthEqual1) {
                // trying to save some steps where typically the answer is 1 so avoid complicated for loop
        ...
        // just in case it increases capacity free up extra memory
        parsedCompounds.trimToSize();
    }
