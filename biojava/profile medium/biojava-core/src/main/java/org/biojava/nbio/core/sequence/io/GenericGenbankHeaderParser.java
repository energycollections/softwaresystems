...
public class GenericGenbankHeaderParser<S extends AbstractSequence<C>, C extends Compound> implements SequenceHeaderParserInterface<S, C> {
    ...
    private java.util.List<String> comments = new org.eclipse.collections.impl.list.mutable.FastList<>();

    private List<AbstractReference> references = new org.eclipse.collections.impl.list.mutable.FastList<>();
