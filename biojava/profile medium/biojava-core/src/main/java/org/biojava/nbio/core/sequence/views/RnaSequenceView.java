...
public class RnaSequenceView extends SequenceProxyView<NucleotideCompound> implements ProxySequenceReader<NucleotideCompound> {
    ...
    protected void buildTranslators() {
        Map<NucleotideCompound, NucleotideCompound> localDnaToRna = new org.apache.commons.collections4.map.HashedMap<NucleotideCompound, NucleotideCompound>();
        Map<NucleotideCompound, NucleotideCompound> localRnaToDna = new org.apache.commons.collections4.map.HashedMap<NucleotideCompound, NucleotideCompound>();
