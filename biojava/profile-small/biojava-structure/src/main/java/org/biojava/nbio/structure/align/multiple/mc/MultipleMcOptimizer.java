...
public class MultipleMcOptimizer implements Callable<MultipleAlignment> {
    ...
    // number of aligned structures without a gap
    private int Rmin;

    // Minimum alignment length of a Block
    private int Lmin;

    // Steps without score change before stopping
    private int convergenceSteps;

    // Probability function constant
    private double C;
    ...
    // number of structures in the alignment
    private int size;

    // the number of Blocks in the alignment
    private int blockNr;

    // Optimization score, objective function
    ...
    public MultipleMcOptimizer(MultipleAlignment seedAln, MultipleMcParameters params, int reference) {
        ...
        List<Block> toDelete = new org.apache.commons.collections4.list.NodeCachingLinkedList<Block>();
        List<BlockSet> emptyBs = new org.apache.commons.collections4.list.NodeCachingLinkedList<BlockSet>();
    ...
    public MultipleAlignment optimize() throws StructureException {
        ...
        while (i < maxIter && conv < convergenceSteps) {
            ...
            List<SortedSet<Integer>> lastFreePool = new org.apache.commons.collections4.list.NodeCachingLinkedList<SortedSet<Integer>>();
