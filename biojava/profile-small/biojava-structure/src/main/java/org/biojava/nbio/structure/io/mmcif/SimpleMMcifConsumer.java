...
public class SimpleMMcifConsumer implements MMcifConsumer {
    ...
    public void newAtomSite(AtomSite atom) {
        ...
        if (!currentNmrModelNumber.equals(nmrModelNumber)) {
            ...
            currentModel = new org.apache.commons.collections4.list.NodeCachingLinkedList<Chain>();
            currentChain = null;
            currentGroup = null;
        }
        if (currentChain == null) {
    ...
    public void documentStart() {
        ...
        currentModel = new org.apache.commons.collections4.list.NodeCachingLinkedList<Chain>();
        entities = new org.apache.commons.collections4.list.NodeCachingLinkedList<Entity>();
        entityPolys = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        strucRefs = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructRef>();
        seqResChains = new org.apache.commons.collections4.list.NodeCachingLinkedList<Chain>();
        entityChains = new org.apache.commons.collections4.list.NodeCachingLinkedList<Chain>();
        structAsyms = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructAsym>();
        asymId2entityId = new HashMap<String, String>();
        asymId2authorId = new HashMap<>();
        structOpers = new org.apache.commons.collections4.list.NodeCachingLinkedList<PdbxStructOperList>();
        strucAssemblies = new org.apache.commons.collections4.list.NodeCachingLinkedList<PdbxStructAssembly>();
        strucAssemblyGens = new org.apache.commons.collections4.list.NodeCachingLinkedList<PdbxStructAssemblyGen>();
        entitySrcGens = new org.apache.commons.collections4.list.NodeCachingLinkedList<EntitySrcGen>();
        entitySrcNats = new org.apache.commons.collections4.list.NodeCachingLinkedList<EntitySrcNat>();
        entitySrcSyns = new org.apache.commons.collections4.list.NodeCachingLinkedList<EntitySrcSyn>();
        structConn = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructConn>();
        structNcsOper = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructNcsOper>();
        sequenceDifs = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructRefSeqDif>();
        structSiteGens = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructSiteGen>();
    }
    ...
    private void setStructNcsOps() {
        java.util.List<Matrix4d> ncsOperators = new org.apache.commons.collections4.list.NodeCachingLinkedList<Matrix4d>();
