...
public class DownloadChemCompProvider implements ChemCompProvider {
    ...
    static final List<String> protectedIDs = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();
    ...
    private void downloadAllDefinitions() {
        ...
        try {
            ...
            logger.error("Could not download the all chemical components file. Error: {}. " + "Chemical components information won't be available", e.getMessage());
        ...
        try {
            ...
            logger.error("Could not split all chem comp file into individual chemical component files. Error: {}", e.getMessage());
