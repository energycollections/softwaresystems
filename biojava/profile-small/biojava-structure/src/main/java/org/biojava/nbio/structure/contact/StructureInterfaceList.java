...
public class StructureInterfaceList implements Serializable, Iterable<StructureInterface> {
    ...
    public void calcAsas(int nSpherePoints, int nThreads, int cofactorSizeToUse) {
        ...
        logger.debug("Calculated uncomplexed ASA for " + uniqAsaChains.size() + " orientation-unique chains. " + "Time: " + ((end - start) / 1000.0) + " s");
        ...
        logger.debug("Calculated complexes ASA for " + list.size() + " pairwise complexes. " + "Time: " + ((end - start) / 1000.0) + " s");
    ...
    public void addNcsEquivalent(StructureInterface interfaceNew, StructureInterface interfaceRef) {
        ...
        if (clustersNcs == null) {
            clustersNcs = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        }
    ...
    public List<StructureInterfaceCluster> getClusters(double contactOverlapScoreClusterCutoff) {
        ...
        clusters = new org.apache.commons.collections4.list.NodeCachingLinkedList<StructureInterfaceCluster>();
    ...
    public static StructureInterfaceList calculateInterfaces(Structure struc) {
        ...
        interfaces.calcAsas(// fewer for performance
