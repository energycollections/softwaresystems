...
public class CrystalBuilder {
    ...
    private java.util.List<CrystalTransform> visitedCrystalTransforms;
    ...
    private void initialiseVisited() {
        visitedCrystalTransforms = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        if (this.hasNcsOps()) {
    ...
    public static void expandNcsOps(Structure structure, Map<String, String> chainOrigNames, Map<String, Matrix4d> chainNcsOps) {
        ...
        if (xtalInfo.getNcsOperators() == null || xtalInfo.getNcsOperators().length == 0)
            return;
        List<Chain> chainsToAdd = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
