...
public class AsaCalculator {
    ...
    private Integer[] findNeighborIndices(int k) {
        ...
        java.util.List<Integer> neighbor_indices = new org.apache.commons.collections4.list.NodeCachingLinkedList<>(40);
    ...
    private static double getRadiusForAmino(AminoAcid amino, Atom atom) {
        ...
        if (atom.getElement() == Element.O) {
            ...
            } else if (atomCode.equals("CA") || atomCode.equals("CB") || atomCode.equals("CE") || atomCode.equals("CG1") || atomCode.equals("CG2")) {
                // tetrahedral Carbon
