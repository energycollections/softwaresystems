...
public class PDBBioAssemblyParser {
    ...
    private List<String> currentChainIDs = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();
    ...
    private void initialize() {
        transformations = new org.apache.commons.collections4.list.NodeCachingLinkedList<BiologicalAssemblyTransformation>();
        currentMatrix = Matrix.identity(3, 3);
