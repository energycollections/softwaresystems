...
public class GridCell {
    ...
    private java.util.List<Integer> iIndices;

    private java.util.List<Integer> jIndices;

    public GridCell(Grid parent) {
        iIndices = new org.apache.commons.collections4.list.NodeCachingLinkedList<Integer>();
        jIndices = new org.apache.commons.collections4.list.NodeCachingLinkedList<Integer>();
        this.grid = parent;
    }
