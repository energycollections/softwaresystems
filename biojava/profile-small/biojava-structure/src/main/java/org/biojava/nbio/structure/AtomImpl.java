...
public class AtomImpl implements Atom {
    ...
    public AtomImpl() {
        ...
        altLoc = 0;
        parent = null;
        // let's save some memory and let's not initialise this until it's needed - JD 2016-03-02
        bonds = null;
        charge = 0;
    }
    ...
    public void addBond(Bond bond) {
        if (bonds == null) {
            bonds = new org.apache.commons.collections4.list.NodeCachingLinkedList<Bond>(BONDS_INITIAL_CAPACITY);
        }
        bonds.add(bond);
    }
