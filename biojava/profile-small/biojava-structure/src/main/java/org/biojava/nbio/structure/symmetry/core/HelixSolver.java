...
public class HelixSolver {
    ...
    private void solve() {
        ...
        Set<List<Integer>> permutations = new org.eclipse.collections.impl.set.mutable.UnifiedSet<List<Integer>>();
        // for n-start
        ...
        for (Entry<Integer[], Integer> entry : interactionMap.entrySet()) {
            ...
            Set<Integer> permSet = new org.eclipse.collections.impl.set.mutable.UnifiedSet<Integer>();
            int count = 0;
            boolean valid = true;
            ...
            List<Point3d> point1 = new org.apache.commons.collections4.list.NodeCachingLinkedList<Point3d>();
            List<Point3d> point2 = new org.apache.commons.collections4.list.NodeCachingLinkedList<Point3d>();
