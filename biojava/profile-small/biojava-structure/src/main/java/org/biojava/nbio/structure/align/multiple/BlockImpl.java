...
public class BlockImpl extends AbstractScoresCache implements Serializable, Block, Cloneable {
    ...
    public BlockImpl(BlockSet blockSet) {
        ...
        alignRes = null;
        // Value -1 indicates not yet calculated.
        coreLength = -1;
        // Value null not yet calculated
        alignResCounts = null;
    }
    ...
    public List<Integer> getAlignResCounts() {
        ...
        alignResCounts = new org.apache.commons.collections4.list.NodeCachingLinkedList<Integer>(size());
