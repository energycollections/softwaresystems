...
public class QuatSymmetrySubunits {
    ...
    private List<Point3d> originalCenters = new org.apache.commons.collections4.list.NodeCachingLinkedList<Point3d>();

    private List<Point3d> centers = new org.apache.commons.collections4.list.NodeCachingLinkedList<Point3d>();

    private List<Vector3d> unitVectors = new org.apache.commons.collections4.list.NodeCachingLinkedList<Vector3d>();

    private List<Integer> folds = new ArrayList<Integer>();

    private List<Integer> clusterIds = new org.apache.commons.collections4.list.NodeCachingLinkedList<Integer>();
