...
public class SymmetryAxes {
    ...
    public List<List<Integer>> getRepeatRelation(int level, int firstRepeat) {
        ...
        List<Integer> repeats = new org.apache.commons.collections4.list.NodeCachingLinkedList<>(n);
        List<Integer> equiv = new org.apache.commons.collections4.list.NodeCachingLinkedList<>(n);
        for (int i = 0; i < n; i++) {
