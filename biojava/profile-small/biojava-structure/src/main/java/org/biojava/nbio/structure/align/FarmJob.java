...
public class FarmJob implements Runnable {
    ...
    public void addAlignmentProgressListener(AlignmentProgressListener listener) {
        if (progressListeners == null)
            progressListeners = new org.apache.commons.collections4.list.NodeCachingLinkedList<AlignmentProgressListener>();
    ...
    public void run() {
        ...
        jobs = new org.apache.commons.collections4.list.NodeCachingLinkedList<FarmJobRunnable>();
