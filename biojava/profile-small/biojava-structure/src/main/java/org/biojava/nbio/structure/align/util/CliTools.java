...
public class CliTools {
    ...
    public static String[] configureBean(Object bean, String[] args) throws ConfigurationException {
        ...
        List<String> anonArgs = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();
        Map<PropertyDescriptor, List<String>> arrayProps = new HashMap<PropertyDescriptor, List<String>>();
        Set<PropertyDescriptor> usedProps = new org.eclipse.collections.impl.set.mutable.UnifiedSet<PropertyDescriptor>();
