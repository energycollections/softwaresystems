...
public class HelicalRepeatUnit {
    ...
    private List<List<Integer>> repeatUnitIndices = new org.apache.commons.collections4.list.NodeCachingLinkedList<List<Integer>>();
    ...
    private List<Point3d> calcRepeatUnitCenters() {
        ...
        for (int s = 0; s < subunits.getSubunitCount(); s++) models.add(0);
    ...
    private Map<Integer[], Integer> findInteractingNeigbors() {
        ...
        for (List<Integer[]> pairs : distanceMap.values()) for (Integer[] pair : pairs) {
