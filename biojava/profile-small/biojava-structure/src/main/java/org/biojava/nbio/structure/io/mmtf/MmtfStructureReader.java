...
public class MmtfStructureReader implements StructureAdapterInterface, Serializable {
    ...
    public MmtfStructureReader() {
        ...
        modelNumber = 0;
        entityInfoList = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        chainList = new ArrayList<>();
        chainMap = new ArrayList<>();
        transformList = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
