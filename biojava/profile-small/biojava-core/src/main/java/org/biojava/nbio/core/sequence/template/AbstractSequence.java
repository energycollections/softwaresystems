...
public abstract class AbstractSequence<C extends Compound> implements Sequence<C> {
    ...
    private java.util.List<String> notesList = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();
    ...
    private java.util.List<FeatureInterface<AbstractSequence<C>, C>> features = new org.apache.commons.collections4.list.NodeCachingLinkedList<FeatureInterface<AbstractSequence<C>, C>>();

    private LinkedHashMap<String, ArrayList<FeatureInterface<AbstractSequence<C>, C>>> groupedFeatures = new LinkedHashMap<String, ArrayList<FeatureInterface<AbstractSequence<C>, C>>>();
    ...
    public void addFeature(int bioStart, int bioEnd, FeatureInterface<AbstractSequence<C>, C> feature) {
        SequenceLocation<AbstractSequence<C>, C> sequenceLocation = new SequenceLocation<AbstractSequence<C>, C>(bioStart, bioEnd, this);
