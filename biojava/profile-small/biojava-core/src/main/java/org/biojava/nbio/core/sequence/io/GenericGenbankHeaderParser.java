...
public class GenericGenbankHeaderParser<S extends AbstractSequence<C>, C extends Compound> implements SequenceHeaderParserInterface<S, C> {
    ...
    private java.util.List<String> comments = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();

    private List<AbstractReference> references = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
