...
public class AAIndexFileParser {
    ...
    private void initMatrix(String line) {
        ...
        rows = new org.apache.commons.collections4.list.NodeCachingLinkedList<AminoAcidCompound>();
        cols = new org.apache.commons.collections4.list.NodeCachingLinkedList<AminoAcidCompound>();
