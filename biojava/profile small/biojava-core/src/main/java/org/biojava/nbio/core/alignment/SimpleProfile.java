...
public class SimpleProfile<S extends Sequence<C>, C extends Compound> implements Serializable, Profile<S, C> {
    ...
    protected SimpleProfile(AlignedSequence<S, C> query, AlignedSequence<S, C> target) {
        ...
        originals = new org.apache.commons.collections4.list.NodeCachingLinkedList<S>();
    ...
    public String toString(StringFormat format) {
        switch(format) {
            ...
            case CLUSTALW:
            default:
                return toString(60, String.format("CLUSTAL W MSA from BioJava%n%n"), IOUtils.getIDFormat(list) + "   ", false, true, true, false, true, false);
            case FASTA:
                return toString(60, null, ">%s%n", false, false, false, false, false, false);
            case GCG:
            case MSF:
                return toString(50, IOUtils.getGCGHeader(list), IOUtils.getIDFormat(list), false, false, true, false, false, false);
            case PDBWEB:
