...
public abstract class AbstractLocation implements Serializable, Location {
    ...
    public Iterator<Location> iterator() {
        ...
        if (isComplex()) {
            ...
            list = new org.apache.commons.collections4.list.NodeCachingLinkedList<Location>();
            list.add(this);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (classEqual(this, obj)) {
            ...
            equals = (equal(getStart(), l.getStart()) && equal(getEnd(), l.getEnd()) && equal(getStrand(), l.getStrand()) && equal(isCircular(), l.isCircular()) && equal(isBetweenCompounds(), l.isBetweenCompounds()) && equal(getSubLocations(), l.getSubLocations()) && equal(getAccession(), l.getAccession()));
        }
        return equals;
    }
    ...
    public String toString() {
        ...
        return format("%d%s%d(%s%s)", getStart().getPosition(), between, getEnd().getPosition(), getStrand().getStringRepresentation(), circ);
    }
