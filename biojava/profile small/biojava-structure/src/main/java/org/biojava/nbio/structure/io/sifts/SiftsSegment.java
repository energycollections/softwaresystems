...
public class SiftsSegment implements Serializable {
    ...
    public SiftsSegment(String segId, String start, String end) {
        ...
        this.start = start;
        this.end = end;
        residues = new org.apache.commons.collections4.list.NodeCachingLinkedList<SiftsResidue>();
    }
    ...
    public String toString() {
        return "SiftsSegment [segId=" + segId + ", start=" + start + ", end=" + end + ", residues=" + residues + "]";
    }
