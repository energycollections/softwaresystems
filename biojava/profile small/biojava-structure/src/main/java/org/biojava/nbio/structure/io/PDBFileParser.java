...
public class PDBFileParser {
    ...
    private List<String> compndLines = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();

    private List<String> sourceLines = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();

    private List<String> journalLines = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();
    ...
    private List<SSBondImpl> ssbonds = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
    ...
    public PDBFileParser() {
        ...
        allModels = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        structure = null;
        currentModel = null;
        currentChain = null;
        currentGroup = null;
        ...
        connects = new org.apache.commons.collections4.list.NodeCachingLinkedList<Map<String, Integer>>();
        helixList = new org.apache.commons.collections4.list.NodeCachingLinkedList<Map<String, String>>();
        strandList = new org.apache.commons.collections4.list.NodeCachingLinkedList<Map<String, String>>();
        turnList = new org.apache.commons.collections4.list.NodeCachingLinkedList<Map<String, String>>();
        current_compound = null;
        dbrefs = new org.apache.commons.collections4.list.NodeCachingLinkedList<DBRef>();
        siteMap = null;
        ...
        linkRecords = new org.apache.commons.collections4.list.NodeCachingLinkedList<LinkRecord>();
    ...
    private void pdb_MTRIXn_Handler(String line) {
        ...
        try {
            ...
            if (ncsOperators == null) {
                ...
                ncsOperators = new org.apache.commons.collections4.list.NodeCachingLinkedList<Matrix4d>();
            }
    ...
    private void pdb_ATOM_Handler(String line) {
        ...
        if (startOfModel) {
            ...
            currentModel = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        }
