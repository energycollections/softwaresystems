...
public class ClusterAltAligs {
    ...
    public static void cluster(AlternativeAlignment[] aligs, int cutoff) {
        ...
        List testAligs = new org.apache.commons.collections4.list.NodeCachingLinkedList(alist);
        List clusters = new org.apache.commons.collections4.list.NodeCachingLinkedList();
        List excludeList = new org.apache.commons.collections4.list.NodeCachingLinkedList();
        ...
        for (int i = 0; i < aligs.length; i++) {
            ...
            List remainList = new org.apache.commons.collections4.list.NodeCachingLinkedList();
