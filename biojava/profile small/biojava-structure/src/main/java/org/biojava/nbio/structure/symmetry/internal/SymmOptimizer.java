...
public class SymmOptimizer {
    ...
    // min aligned repeats per column
    private int Rmin = 2;
    ...
    // probability of accept bad moves constant
    private double C = 20;
    ...
    // total alignment columns (block size)
    private int length;

    // core length (without gaps)
    ...
    // residues not aligned
    private List<Integer> freePool;

    // alignment score to optimize
    ...
    private void initialize() throws StructureException, RefinerFailedException {
        ...
        timeHistory = new org.eclipse.collections.impl.list.mutable.FastList<Long>();
        lengthHistory = new org.eclipse.collections.impl.list.mutable.FastList<Integer>();
        rmsdHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();
        mcScoreHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();
        tmScoreHistory = new org.eclipse.collections.impl.list.mutable.FastList<Double>();
        C = 20 * order;
        // Initialize alignment variables
        block = msa.getBlock(0).getAlignRes();
        freePool = new org.apache.commons.collections4.list.NodeCachingLinkedList<Integer>();
        length = block.get(0).size();
        // Store the residues aligned in the block
        List<Integer> aligned = new ArrayList<Integer>();
        for (int su = 0; su < order; su++) aligned.addAll(block.get(su));
    ...
    public MultipleAlignment optimize() throws StructureException, RefinerFailedException {
        ...
        List<List<Integer>> optBlock = new org.apache.commons.collections4.list.NodeCachingLinkedList<List<Integer>>();
        ...
        while (i < maxIter && conv < stepsToConverge) {
            ...
            List<List<Integer>> lastBlock = new org.apache.commons.collections4.list.NodeCachingLinkedList<List<Integer>>();
