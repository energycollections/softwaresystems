...
public class RCSBUpdates {
    ...
    public Map<String, String[]> getUpdates() throws IOException {
        ...
        String[] newStringList = { "added.models", "added.nmr", "added.pdb", "added.sf", "modified.cs", "modified.models", "modified.nmr", "modified.pdb", "modified.sf", "obsolete.cs", "obsolete.models", "obsolete.nmr", "obsolete.pdb", "obsolete.sf" };
    ...
    private String[] readURL(String urlIn) throws IOException {
        List<String> outList = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>();
        // create a url object
