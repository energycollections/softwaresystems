...
public class FastaAFPChainConverter {
    ...
    public static AFPChain fastaToAfpChain(Map<String, ProteinSequence> sequences, Structure structure1, Structure structure2) throws StructureException {
        ...
        List<String> names = new org.apache.commons.collections4.list.NodeCachingLinkedList<String>(2);
    ...
    private static AFPChain buildAlignment(Atom[] ca1, Atom[] ca2, ResidueNumber[] residues1, ResidueNumber[] residues2) throws StructureException {
        ...
        List<ResidueNumber> alignedResiduesList1 = new org.apache.commons.collections4.list.NodeCachingLinkedList<ResidueNumber>();
        List<ResidueNumber> alignedResiduesList2 = new org.apache.commons.collections4.list.NodeCachingLinkedList<ResidueNumber>();
