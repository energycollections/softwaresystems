    ...
    public static void updateSymmetryTransformation(SymmetryAxes axes, MultipleAlignment msa) throws StructureException {
        ...
        if (axes != null) {
            for (int level = 0; level < axes.getNumLevels(); level++) {
                ...
                List<Atom> list1 = new org.apache.commons.collections4.list.NodeCachingLinkedList<Atom>();
                List<Atom> list2 = new org.apache.commons.collections4.list.NodeCachingLinkedList<Atom>();
