...
public class JournalArticle implements Serializable {
    ...
    private List<Author> authorList = new org.apache.commons.collections4.list.NodeCachingLinkedList<Author>();

    private List<Author> editorList = new org.apache.commons.collections4.list.NodeCachingLinkedList<Author>();
