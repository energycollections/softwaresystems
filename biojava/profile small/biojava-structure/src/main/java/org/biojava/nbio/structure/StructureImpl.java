...
public class StructureImpl implements Structure {
    ...
    public StructureImpl() {
        ...
        name = "";
        entityInfos = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        dbrefs = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        pdbHeader = new PDBHeader();
        ssbonds = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
        sites = new ArrayList<>();
    }
    ...
    public Group findGroup(String chainName, String pdbResnum, int modelnr) throws StructureException {
        ...
        if (modelnr > models.size())
            throw new StructureException(" no model nr " + modelnr + " in this structure. (contains " + models.size() + ")");
        ...
        if (polyChain != null) {
            List<Group> groups = new org.apache.commons.collections4.list.NodeCachingLinkedList<>();
