...
public class StockholmFileAnnotation {
    ...
    public static class StockholmFileAnnotationReference {
        ...
        // TODO comma-separated, semicolon terminated list;
    ...
    public StockholmFileAnnotation() {
        embTrees = new org.apache.commons.collections4.map.HashedMap<String, List<String>>();
    }
    ...
    public void addDBReference(String dbReferenceRepresentingString) {
        if (this.dbReferences == null) {
            this.dbReferences = new org.eclipse.collections.impl.set.mutable.UnifiedSet<DatabaseReference>();
        }
    ...
    public boolean isPFam() {
        return accessionNumber != null && (accessionNumber.startsWith(PF_PFAM_STRING) || accessionNumber.startsWith(PB_PFAM_STRING));
    }
