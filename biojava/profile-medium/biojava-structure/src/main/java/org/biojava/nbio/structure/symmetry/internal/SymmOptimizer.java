...
public class SymmOptimizer {
    ...
    private void initialize() throws StructureException, RefinerFailedException {
        ...
        freePool = new org.eclipse.collections.impl.list.mutable.FastList<Integer>();
    ...
    public MultipleAlignment optimize() throws StructureException, RefinerFailedException {
        ...
        List<List<Integer>> optBlock = new org.eclipse.collections.impl.list.mutable.FastList<List<Integer>>();
        ...
        while (i < maxIter && conv < stepsToConverge) {
            ...
            List<List<Integer>> lastBlock = new org.eclipse.collections.impl.list.mutable.FastList<List<Integer>>();
