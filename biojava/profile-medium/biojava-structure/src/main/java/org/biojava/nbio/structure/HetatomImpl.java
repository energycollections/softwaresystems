...
public class HetatomImpl implements Group {
    ...
    public HetatomImpl() {
        ...
        pdb_name = null;
        residueNumber = null;
        atoms = new org.eclipse.collections.impl.list.mutable.FastList<Atom>();
        properties = new org.apache.commons.collections4.map.HashedMap<String, Object>();
        parent = null;
        chemComp = null;
        altLocs = null;
        if (performanceBehavior == PerformanceBehavior.BETTER_PERFORMANCE_MORE_MEMORY)
            atomNameLookup = new org.apache.commons.collections4.map.HashedMap<String, Atom>();
        else
            atomNameLookup = null;
    }
    ...
    public void addAltLoc(Group group) {
        if (altLocs == null) {
            altLocs = new org.eclipse.collections.impl.list.mutable.FastList<Group>();
        }
        altLocs.add(group);
    }
    ...
    public void trimToSize() {
        ...
        properties = new org.apache.commons.collections4.map.HashedMap<String, Object>(properties);
        if (atomNameLookup != null)
            atomNameLookup = new org.apache.commons.collections4.map.HashedMap<String, Atom>(atomNameLookup);
    }
