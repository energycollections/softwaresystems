...
public class CliTools {
    ...
    public static String[] configureBean(Object bean, String[] args) throws ConfigurationException {
        ...
        List<String> anonArgs = new org.eclipse.collections.impl.list.mutable.FastList<String>();
        Map<PropertyDescriptor, List<String>> arrayProps = new org.apache.commons.collections4.map.HashedMap<PropertyDescriptor, List<String>>();
