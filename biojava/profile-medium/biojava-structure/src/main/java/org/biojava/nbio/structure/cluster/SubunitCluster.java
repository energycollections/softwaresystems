...
public class SubunitCluster {
    ...
    public boolean mergeSequence(SubunitCluster other, SubunitClustererParameters params, PairwiseSequenceAlignerType alignerType, GapPenalty gapPenalty, SubstitutionMatrix<AminoAcidCompound> subsMatrix) throws CompoundNotFoundException {
        ...
        List<Integer> thisAligned = new org.eclipse.collections.impl.list.mutable.FastList<Integer>();
        List<Integer> otherAligned = new org.eclipse.collections.impl.list.mutable.FastList<Integer>();
    ...
    public boolean divideInternally(SubunitClustererParameters clusterParams) throws StructureException {
        ...
        List<Subunit> newSubunits = new org.eclipse.collections.impl.list.mutable.FastList<Subunit>(subunits.size() * columns.size());
        List<List<Integer>> newSubunitEQR = new org.eclipse.collections.impl.list.mutable.FastList<List<Integer>>(subunits.size() * columns.size());
