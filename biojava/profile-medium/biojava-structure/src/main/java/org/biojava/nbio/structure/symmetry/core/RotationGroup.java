...
public class RotationGroup implements Iterable<Rotation> {
    ...
    private List<Rotation> rotations = new org.eclipse.collections.impl.list.mutable.FastList<Rotation>();
    ...
    private void calcAxesDirections() {
        ...
        // set the E axis to the principal axis (by definition)
        rotations.get(0).setDirection(0);
    }
