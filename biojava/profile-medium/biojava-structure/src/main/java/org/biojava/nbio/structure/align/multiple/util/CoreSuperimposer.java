    ...
    public void superimpose(MultipleAlignment alignment) throws StructureException {
        ...
        for (BlockSet bs : alignment.getBlockSets()) {
            ...
            for (int i = 0; i < atomArrays.size(); i++) {
                ...
                List<Atom> atomSet1 = new org.eclipse.collections.impl.list.mutable.FastList<Atom>();
                List<Atom> atomSet2 = new org.eclipse.collections.impl.list.mutable.FastList<Atom>();
