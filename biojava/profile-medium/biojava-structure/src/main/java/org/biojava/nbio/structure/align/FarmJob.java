...
public class FarmJob implements Runnable {
    ...
    public void addAlignmentProgressListener(AlignmentProgressListener listener) {
        if (progressListeners == null)
            progressListeners = new org.eclipse.collections.impl.list.mutable.FastList<AlignmentProgressListener>();
    ...
    public void run() {
        ...
        jobs = new org.eclipse.collections.impl.list.mutable.FastList<FarmJobRunnable>();
