...
public class ClusterAltAligs {
    ...
    public static void cluster(AlternativeAlignment[] aligs, int cutoff) {
        ...
        List testAligs = new org.eclipse.collections.impl.list.mutable.FastList(alist);
        List clusters = new org.eclipse.collections.impl.list.mutable.FastList();
        List excludeList = new org.eclipse.collections.impl.list.mutable.FastList();
        ...
        for (int i = 0; i < aligs.length; i++) {
            ...
            List remainList = new org.eclipse.collections.impl.list.mutable.FastList();
