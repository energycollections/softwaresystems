...
public class MmtfStructureReader implements StructureAdapterInterface, Serializable {
    ...
    public MmtfStructureReader() {
        ...
        modelNumber = 0;
        entityInfoList = new org.eclipse.collections.impl.list.mutable.FastList<>();
        chainList = new ArrayList<>();
        chainMap = new org.eclipse.collections.impl.list.mutable.FastList<>();
        transformList = new org.eclipse.collections.impl.list.mutable.FastList<>();
