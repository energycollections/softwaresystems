...
public class StructureImpl implements Structure {
    ...
    public StructureImpl() {
        ...
        name = "";
        entityInfos = new org.eclipse.collections.impl.list.mutable.FastList<>();
        dbrefs = new org.eclipse.collections.impl.list.mutable.FastList<>();
        pdbHeader = new PDBHeader();
        ssbonds = new org.eclipse.collections.impl.list.mutable.FastList<>();
        sites = new ArrayList<>();
    }
    ...
    public Group findGroup(String chainName, String pdbResnum, int modelnr) throws StructureException {
        ...
        if (polyChain != null) {
            List<Group> groups = new org.eclipse.collections.impl.list.mutable.FastList<>();
