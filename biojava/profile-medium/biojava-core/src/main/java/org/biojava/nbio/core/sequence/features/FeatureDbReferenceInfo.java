...
public class FeatureDbReferenceInfo<S extends AbstractSequence<C>, C extends Compound> extends DBReferenceInfo implements FeatureInterface<S, C> {
    ...
    private Map<String, List<Qualifier>> qualifiers = new org.apache.commons.collections4.map.HashedMap<String, List<Qualifier>>();
    ...
    public void addQualifier(String key, Qualifier qualifier) {
        if (qualifiers == null) {
            qualifiers = new org.apache.commons.collections4.map.HashedMap<String, List<Qualifier>>();
        }
