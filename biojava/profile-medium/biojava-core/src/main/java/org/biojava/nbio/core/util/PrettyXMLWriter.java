...
public class PrettyXMLWriter implements XMLWriter {
    ...
    private java.util.List<List<String>> namespaceBindings = new org.eclipse.collections.impl.list.mutable.FastList<List<String>>();

    private List<String> namespacesDeclared = new org.eclipse.collections.impl.list.mutable.FastList<String>();
