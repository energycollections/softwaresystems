...
public class SearchIO implements Iterable<Result> {
    ...
    static private java.util.Map<String, ResultFactory> extensionFactoryAssociation;
    ...
    private ResultFactory guessFactory(File f) {
        if (extensionFactoryAssociation == null) {
            extensionFactoryAssociation = new org.apache.commons.collections4.map.HashedMap<String, ResultFactory>();
