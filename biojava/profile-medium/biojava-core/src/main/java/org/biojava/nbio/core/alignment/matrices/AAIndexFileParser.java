...
public class AAIndexFileParser {
    ...
    public AAIndexFileParser() {
        matrices = new org.apache.commons.collections4.map.HashedMap<String, SubstitutionMatrix<AminoAcidCompound>>();
    }
    ...
    private void initMatrix(String line) {
        ...
        rows = new org.eclipse.collections.impl.list.mutable.FastList<AminoAcidCompound>();
        cols = new org.eclipse.collections.impl.list.mutable.FastList<AminoAcidCompound>();
