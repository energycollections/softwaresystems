...
final class MultiFinderPatternFinder extends FinderPatternFinder {
     ...
     */
        ...
        List<FinderPattern[]> results = new org.eclipse.collections.impl.list.mutable.FastList<>();
    ...
    public FinderPatternInfo[] findMulti(Map<DecodeHintType, ?> hints) throws NotFoundException {
        ...
        List<FinderPatternInfo> result = new org.eclipse.collections.impl.list.mutable.FastList<>();
