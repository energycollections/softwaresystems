...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private final List<ExpandedPair> pairs = new org.eclipse.collections.impl.list.mutable.FastList<>(MAX_PAIRS);

    private final List<ExpandedRow> rows = new org.apache.commons.collections4.list.TreeList<>();
